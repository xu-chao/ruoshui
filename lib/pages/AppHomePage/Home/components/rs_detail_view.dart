...
class RsDetailView extends StatelessWidget {
  final AnimationController animationController;
  final Animation animation;

  const RsDetailView({Key key, this.animationController, this.animation})
      : super(key: key);
